...
export const StarIcon = ({ addFav, active = false }: { active: boolean, addFav: () => void }) => {
  const { classes, cx } = useStarStyle()
  return (
    <svg onClick={addFav} className={cx(classes.icon, { [classes.active]: active })} width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
